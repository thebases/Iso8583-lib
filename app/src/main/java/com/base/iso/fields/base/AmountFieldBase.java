...
public class AmountFieldBase extends aISOFieldBase {
    private iPadder padder;
    private Interpreter interpreter;
    private iPrefixer prefixer;

    /**
     * Creates an AmountFieldBase.
     * 
     * @param maxLength   The maximum length of the field in characters or bytes
     ...
     */
    public AmountFieldBase(int maxLength, String description, iPadder padder,
    ...
    /**
     * Constructs a default AmountFieldBase. There is no padding,
     * no length prefix and a literal interpretation. The set methods must be called
     * to
     * make this AmountFieldBase useful.
     */
    public AmountFieldBase() {
        super();
    ...
    /**
     * Constructs an AmountFieldBase with a specific Padder, Interpreter and
     * Prefixer.
     * The length and description should be set with setLength() and setDescription
     * methods.
     * 
     * @param padder      The type of padding used.
     * @param interpreter The interpreter used to encode the field.
     * @param prefixer    The type of length prefixer used to encode this field.
     */
    public AmountFieldBase(iPadder padder, Interpreter interpreter, iPrefixer prefixer) {
        super();
        this.padder = padder;
        this.interpreter = interpreter;
        this.prefixer = prefixer;
     ...
     * This is designed to be called from field Packager constructors and the
     * setLength()
     * method.
     * 
