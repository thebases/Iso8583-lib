...
public class FilledStringFieldBase extends aISOFieldBase
{
    ...
    /**
     * Constructs a default FilledStringFieldBase. There is no padding,
     * no length prefix and a literal interpretation. The set methods must be called to
     * make this useful.
     */
    public FilledStringFieldBase()
    {
        super();
    ...
    /**
     * Constructs an FilledStringFieldBase with a specific Padder, Interpreter and Prefixer.
     ...
     */
    public FilledStringFieldBase(iPadder padder, Interpreter interpreter, iPrefixer prefixer)
    {
        super();
        this.padder = padder;
    ...
    /**
     * Creates an FilledStringFieldBase.
     ...
     * @param prefixer The type of length prefixer used to encode this field.
     */
    public FilledStringFieldBase(int maxLength, String description, iPadder padder,
