...
import com.base.iso.packager.aBasePackager;
...
public class ISOMsg extends BaseComponent
    implements Cloneable, iLoggeable, Externalizable
{
    protected Map<Integer,Object> fields;
    protected int maxField;
    protected iPackager packager;
    ...
    */
    public void set(int fldno, String value) throws BaseException {
        if (value != null) {
            if (!(packager instanceof aBasePackager)) {
                ...
                Object obj = ((aBasePackager) packager).getFieldPackager(fldno);
                if (obj instanceof BinaryFieldBase) {
                    set(new BinaryFieldComponent(fldno, ISOUtil.hex2byte(value)));
                } else {
                    set(new ISOField(fldno, value));
                }
            }
    ...
    * @throws BaseException on error
    */
    public void set (String fpath, String value) throws BaseException {
     ...
     * @throws BaseException on error
     */
     public void set (String fpath, BaseComponent c) throws BaseException {
         StringTokenizer st = new StringTokenizer (fpath, ".");
         ISOMsg m = this;
         for (;;) {
             int fldno = Integer.parseInt(st.nextToken());
    ...
    * @throws BaseException on error
    */
    public void set (String fpath, byte[] value) throws BaseException {
        StringTokenizer st = new StringTokenizer (fpath, ".");
        ISOMsg m = this;
        for (;;) {
            int fldno = Integer.parseInt(st.nextToken());
    ...
    * @throws BaseException on error
    */
    public void set (int fldno, byte[] value) throws BaseException {
        if (value != null)
            set (new BinaryFieldComponent (fldno, value));
        else
            unset (fldno);
    }
     ...
     * @throws BaseException on error
    */
    public void unset (String fpath) throws BaseException {
        StringTokenizer st = new StringTokenizer (fpath, ".");
        ISOMsg m = this;
        ISOMsg lastm = m;
        int fldno = -1 ;
     ...
     */
    public void recalcBitMap () throws BaseException {
        if (!dirty)
            return;
        ...
        for (int i=1; i<=mf; i++)
            if ((fields.get (i)) != null)
                bmap.set (i);
        set (new BitMapComponent (-1, bmap));
        dirty = false;
    }
    /**
     * clone fields
    ...
    @Override
    public void unpack (InputStream in) throws IOException, BaseException {
        synchronized (this) {
    ...
    public void dump (PrintStream p, String indent) {
        BaseComponent c;
        p.print (indent + "{\"" + BaseConstant.ISOMSG_TAG + "\": {");
        switch (direction) {
            case INCOMING:
        ...
        if (fieldNumber != -1)
            p.print (" "+BaseConstant.ID_ATTR +"=\""+fieldNumber +"\"");
        p.println (",");
        String newIndent = indent + "  ";
        if (getPackager() != null) {
           p.println (
              newIndent
           + "\"package\":\"" + getPackager().getDescription() + "\","
           );
        }
        if (header instanceof iLoggeable)
            ((iLoggeable) header).dump (p, newIndent);
        ...
        for (int i=0; i<=maxField; i++) {
            ...
            // 
            if (i == 0) {
             if ((c = (BaseComponent) fields.get (new Integer (-1))) != null)
               c.dump (p, newIndent);
            }
            
        }

        // p.println (indent + "</" + BaseConstant.ISOMSG_TAG+">");
        p.println (indent + "}");
    }
    /**
     ...
     */
    public BaseComponent getComponent(int fldno) {
        return (BaseComponent) fields.get(fldno);
    }
    /**
     ...
     * @throws BaseException on error
     */
    public Object getValue(int fldno) throws BaseException {
        BaseComponent c = getComponent(fldno);
     ...
     * @throws BaseException on error
     */
    public Object getValue (String fpath) throws BaseException {
        StringTokenizer st = new StringTokenizer (fpath, ".");
        ISOMsg m = this;
        Object obj;
        for (;;) {
            ...
            if (st.hasMoreTokens()) {
                if (obj instanceof ISOMsg) {
                    ...
                    throw new BaseException ("Invalid path '" + fpath + "'");
            } else 
                break;
        }
        return obj;
     ...
     * @throws BaseException on error
     */
    public BaseComponent getComponent (String fpath) throws BaseException {
        StringTokenizer st = new StringTokenizer (fpath, ".");
        ISOMsg m = this;
        BaseComponent obj;
        for (;;) {
     ...
     * @throws BaseException on error
     */
     public boolean hasField (String fpath) throws BaseException {
         StringTokenizer st = new StringTokenizer (fpath, ".");
         ISOMsg m = this;
         for (;;) {
             int fldno = Integer.parseInt(st.nextToken());
    ...
    public void setValue(Object obj) throws BaseException {
        throw new BaseException ("setValue N/A in ISOMsg");
    }
    ...
    public Object clone() {
        try {
            ...
            for (Integer k : fields.keySet()) {
                BaseComponent c = (BaseComponent) m.fields.get(k);
    ...
    public Object getKey() throws BaseException {
        if (fieldNumber != -1)
            return fieldNumber;
        throw new BaseException ("This is not a subField");
    }
    @Override
    ...
    /**
     * @param mti new MTI
     * @exception BaseException if message is inner message
     */
    public void setMTI (String mti) throws BaseException {
        if (isInner())
            throw new BaseException ("can't setMTI on inner message");
    ...
    {
        BaseComponent c = getComponent (oldFieldNumber);
    ...
    /**
     * @return current MTI
     * @exception BaseException on inner message or MTI not set
     */
    public String getMTI() throws BaseException {
        if (isInner())
            throw new BaseException ("can't getMTI on inner message");
        else if (!hasField(0))
            throw new BaseException ("MTI not available");
        return (String) getValue(0);
    }
    /**
     * @return true if message "seems to be" a request
     * @exception BaseException on MTI not set
     */
    public boolean isRequest() throws BaseException {
     ...
     * @exception BaseException on MTI not set
     */
    public boolean isResponse() throws BaseException {
        return !isRequest();
    }
    /**
     ...
     * @exception BaseException on MTI not set
     */
    public boolean isRetransmission() throws BaseException {
     ...
     * @exception BaseException on MTI not set or it is not a request
     */
    public void setResponseMTI() throws BaseException {
        if (!isRequest())
            throw new BaseException ("not a request - can't set response MTI");
     ...
     * @exception BaseException on MTI not set or it is not a request
     */
    public void setRetransmissionMTI() throws BaseException {
        if (!isRequest())
            throw new BaseException ("not a request");
    ...
    ClassNotFoundException {
        ...
        try {
            ...
            iPackager myp = (iPackager) mypClass.newInstance();
            setPackager(myp);
        } catch (Exception e) {
            setPackager(null);
        }
    ...
    public void writeExternal (ObjectOutput out) throws IOException {
        ...
        for (Object o : fields.values()) {
            BaseComponent c = (BaseComponent) o;
            if (c instanceof ISOMsg) {
                writeExternal(out, 'M', c);
            } else if (c instanceof BinaryFieldComponent) {
                writeExternal(out, 'B', c);
            } else if (c instanceof AmountComponent) {
            ...
            while ((fieldType = in.readByte()) != 'E') {
                ...
                switch (fieldType) {
                    case 'F':
                        ...
                        break;
                    case 'A':
                        c = new AmountComponent ();
                        break;
                    case 'B':
                        c = new BinaryFieldComponent ();
                        break;
                    case 'M':
                        c = new ISOMsg ();
                        break;
    ...
    public iSource getSource () {
        return (sourceRef != null) ? (iSource) sourceRef.get () : null;
    }
    private void writeExternal (ObjectOutput out, char b, BaseComponent c) throws IOException {
        out.writeByte (b);
