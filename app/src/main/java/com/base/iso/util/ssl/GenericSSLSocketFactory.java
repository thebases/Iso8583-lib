...
{ 
     ...
     * @exception BaseException if an error occurs during server socket
     * creation
     */
     ...
     * @exception BaseException should an error occurs during 
     * creation
     */
     ...
     * @exception BaseException should any other error occurs
     */
