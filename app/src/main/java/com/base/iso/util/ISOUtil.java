...
public class ISOUtil {
        ...
        throws BaseException 
    {
        s = s.trim();
        if (s.length() > len)
            throw new BaseException("invalid len " +s.length() + "/" +len);
     ...
     *            padding char
     * @return padded string
     * @throws BaseException if String's length greater than pad length
     */
    public static String padright(String s, int len, char c) throws BaseException {
        s = s.trim();
        if (s.length() > len)
            throw new BaseException("invalid len " + s.length() + "/" + len);
        StringBuilder d = new StringBuilder(len);
    ...
    */
     ...
     * @throws BaseException if string's length greater than len
     */
    public static String zeropad(String s, int len) throws BaseException {
     ...
     */
    public static String formatAmount(long l, int len) throws BaseException {
     ...
     * @return String (may be null)
     */
    public static String takeLastN(String s,int n) throws BaseException {
        if (s.length()>n) {
     ...
     * @return String (may be null)
     */
    public static String takeFirstN(String s,int n) throws BaseException {
        if (s.length()>n) {
     ...
     * @throws BaseException
     */
    public static String formatAmountConversionRate(double convRate) throws BaseException {
        if (convRate == 0)
            return null;
     ...
     * @see com.base.iso.ISOUtil#commaDecode(String)
     ...
     * @see com.base.iso.ISOUtil#commaEncode(String[])
